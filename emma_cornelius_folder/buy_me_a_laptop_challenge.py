...
print(f'All the color options for Dell XPS 13: {laptops[1]["types"][0]["colors"]}')
# TODO: Write code to print the description of Dell XPS laptop.
print(f'Description Dell XPS laptop: {laptops[1]["description"]}')
...
for product in laptops:
    for product_price in product['types']:
        for price in product_price['price']:
            print(price)