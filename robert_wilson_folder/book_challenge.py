...
print(my_library.books)
print(f'There are now {my_library.count_books()} books contained in the list.')
...
nyt_bestsellers.add('Life After Death', 'Sister Souljah')
nyt_bestsellers.add('The Four Winds', 'Kristin Hannah')
