...
rap_song_1 = {"artist": "Nas", "title": "One Mic"}
add_song(my_playlist, rap_song_1)
...
rap_song_2 = {"artist": "Dr. Dre feat. Eminem", "title": "Forgot About Dre"}
rap_song_3 = {"artist": "DMX", "title": "Slippin'"}

add_song(my_playlist, rap_song_2)
add_song(my_playlist, rap_song_3)
...
list_avg = np.mean(monthly_plays)
print(list_avg)
