...
print(type(books))
print("The object 'books' is a 'list'. The output when printed displays <class 'list'>.")
...
def check_in(books):
    books.append ("FROM SUPERMAN TO MAN")
...
print("The object 'books_with_details' is a 'list'. I know this b/c the output when printed displays: <class 'list'>.")
print("The nested data within the list is a dictionary b/c of the curly bracket '{}' enclosing the data.")
...
print(count_books())
print("Sixteen books are available for the books that are in the 'books_with_details' list.") 
...
def search_by_author(author):
    ...
    for book in books_with_details:        
        if book["author"] == author:
            author_of_books.append(book["title"])
    return author_of_books
      
print(search_by_author("Kamala Harris"))         
