...
laptops = [
        ...
        },
        {
            ...
            "description": "The Dell XPS is an absolutely brilliant laptop. The 2020  version rocks an 11th-generation Intel Core i3, i5 or i7 processor and a \nbezel-less ‘Infinity Edge’ display. This Dell XPS continues to be the most popular Windows laptop in the world. What’s more, \nthere’s a wide range of customization options, so you can really make the Dell XPS the best laptop for your needs. "
        }
]
...
print(', '.join(laptops[1]['types'][0]['colors']))
print()
...
print(', '.join(laptops[0]['types'][0]['colors']))
...
for laptop in laptops:
    print(laptop['types'][0]['price'] + laptop['types'][1]['price'], end= " ")
