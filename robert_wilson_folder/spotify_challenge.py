...
result = sp.search(q='artist:' + name, type='artist')  # fill this in
...
print(result['artists']['items'][5]['name']) # uncomment if you want to see the results
print(result['artists']['items'][6]['name']) # uncomment if you want to see the results
...
print(f'Artist Id: {artist_id}') # uncomment if you want to see the results
...
print(f"Popularity_Score for Beyonce is: {artist_info['popularity']} out of 100")

# Followers is a dictionarity itself, with the value 'total' being the total followers. How can we access it?

print(f"The number of Beyonce's followers are: {artist_info['followers']['total']}")
...
chosen_artists = ["Kelly Rowland", "Sade", "Pop Smoke", "Nas", "Common"]
popularities = []
...
print(f"{popularities[2]['name']} is the most popular with a score of {popularities[2]['popularity']}, while {popularities[4]['name']} is the least popular with a score of {popularities[4]['popularity']}")
