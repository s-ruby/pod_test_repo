...
# books is a list.  I know this because it has the square brackets and commas
...
# books_with_details is a dictionary within a list. Within the dictionary are strings.  I know this because of the square 
# brackets (list), squiggly brackets (dicitonary), and single quotes (strings).
...
print(f'number of books in count_books: {count_books()}')
# 2.3
...
print()
tim_books = search_by_author('Timothy Snyder')
print(f'books by tim snyder: {tim_books}')
