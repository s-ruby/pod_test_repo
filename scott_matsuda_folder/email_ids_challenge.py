...
# 2.2 TODO: Inside the "for" loop, create the email id by re-using the logic from Question 1 and...
    email = ('.').join(name.lower().split(' ')) + '@rippledmedia.com'
