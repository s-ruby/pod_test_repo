...
def create_account():
    ...
    balance = 0
    bank_account['username'] = username
...
deposit(my_account, 250)
print(f'account after depositing money: {my_account}')
withdraw_secure(my_account, 100)
print(f'account after secure withdrawal: {my_account}')