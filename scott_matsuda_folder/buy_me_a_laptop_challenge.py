...
print(f"1. Macbook Pro url: {laptops[0]['url']}")
# TODO: Write code to print all possible prices of the 16-inch MacBook Pro.
print()
print(f"2. All possible prices of the 16-inch Macbook Pro: {laptops[0]['types'][1]['price']}")
...
print()
print(f"3. Description of Dell XPS laptop: {laptops[1]['description']}")
print()
...
apple_prices = laptops[0]['types'][0]['price'] + laptops[0]['types'][1]['price']
# print(f"All possible prices for the laptops: {laptops[0]['types'][0]['price']}, {laptops[0]['types'][1]['price']}, {laptops[1]['types'][0]['price']}, {laptops[1]['types'][1]['price']}")
# print(apple_prices)
dell_prices = laptops[1]['types'][0]['price'] + laptops[1]['types'][1]['price']
# print(dell_prices)

total_prices = dell_prices + apple_prices

# print(total_prices)

# remove duplicate price of 1299
res = [] 
for i in total_prices: 
    if i not in res: 
        res.append(i) 
print(f'All possible prices for the laptops: {res}')