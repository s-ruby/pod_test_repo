...
print()
print(f"Address: {restaurant['address1']} {restaurant['city']} {restaurant['state']} {restaurant['zip_code']} {restaurant['country']}")
print()
...
restaurant_1 = {
    ...
    "favorite_dish": "Penne Vodka Pasta"
}
print(restaurant_1)
print()
restaurant_2 = {
...
restaurant_2['address'] = "545 W 133rd St, New York, NY 10027"
