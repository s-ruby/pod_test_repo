...
jam_3pt_percentage = round(float(jamal_murray_3pts_made/jamal_murray_3pts_attempt) * 100, 2)
fred_3pt_percentage = round(float(fred_vanvleet_3pts_made/fred_vanvleet_3pts_attempt) * 100, 2)
hard_3pt_percentage = round(float(james_harden_3pts_made/james_harden_3pts_attempt) * 100, 2)

print(f"In the 2020 NBA playoffs, Jamal Murray shot {jam_3pt_percentage}% from downtown")
print(f"In the 2020 NBA playoffs, Fred VanVleet made {fred_3pt_percentage}% from downtown")
print(f"In the 2020 NBA playoffs, James Harden made {hard_3pt_percentage}% from downtown")
