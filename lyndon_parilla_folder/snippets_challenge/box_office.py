...
# I used the string split function to convert the string into a list and assigned it a variable. Then I printed the variable. 
...
print(remaining_50_list)
# I used the .remove function to remove 'The Matrix' from the list. Then I printed the list again to confirm that it was removed. 
...
print(remaining_50_list)
# I addend the movie ' Anywhere But Here ' to the end of the list. 
...
# I used the len function to count the items in the list. 
...
print(top_100)
print(len(top_100))
# i used the + operator to concatenate the two lists into one. Then I used teh len function to check the number of items in the list. 
...
print(top_100[0])
# The 0 index is the first movie in the list. 
# TODO: Let's print the first movie in our "top_100" list. Let's use the index lookup method to do this.
print()

print(top_100[0:10])
# to print the first ten I have to add one more index since the print function does not print the last index. It stops on the one before it. 
...
print(top_100_str)
# I used the join function to convert the list into a string with a comma as a delimiter. 
