...
print(type(books))
#the data type is a list bc I ran the type function
...
# it is a list with nested dictionaries. bracket is list and braces are dictionaries. 
...
def search_by_author(author):
    ...
    for i in books_with_details:
        if i['author'] == author:
            title_by_author.append(i['title'])
