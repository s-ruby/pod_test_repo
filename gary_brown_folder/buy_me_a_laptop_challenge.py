...
print(f'my url is {laptops[0]["url"]}')

# # TODO: Write code to print all possible prices of the 16-inch MacBook Pro.
print(f'The price of the MacBook Pro is {laptops[0]["types"][1]["price"]}')
