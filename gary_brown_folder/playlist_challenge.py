...
# 'artist' (string)
# 'title' (string)r
song_list = {"artist": "lil wayne","title": "go Dj"}
add_song(my_playlist,{"artist": "lil wayne", "title": "Go Dj"})   
...
print('Question 5')
add_song(my_playlist,{"artist": "50 cent", "title": "In the Club"})  
add_song(my_playlist,{"artist": "Snoopdogg", "title": "Gin and Juice"})  
print(display_playlist(my_playlist))
